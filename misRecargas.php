                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div id="map">
                                    <h1
                                        ...
                                        Mis recargas.</h1>
                                    <p style="padding-left: 20px">Aquí puedes ver un historial de todas tus recargas.</p>
                                </div>
                            </div>
                            <div class="col-lg-12 align-self-center">
                                    ...
                                    <div class="row">
                                        ...
                                        <P style="padding-left: 30px; margin-bottom: 15px; border-bottom: 1px solid black;">CORREO -- MONTO -- FECHA</P>
                                        <?php
                                        include 'assets/php/cn.php';
                                        $sql = "SELECT * FROM Recargas WHERE correo='$loggedEmail'";
                                        $conductorArray = sqlsrv_query($conn,$sql);
                                        while($row = sqlsrv_fetch_array( $conductorArray, SQLSRV_FETCH_ASSOC)):;
                                        ?>
                                        <p style="padding-left: 30px;"><?php echo $row['correo']," -- ₡",$row['monto']," -- ",$row['fecha'] ; ?></p>
